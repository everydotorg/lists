    ...
    <ThemeProvider theme={theme}>
      <Head>
        ...
        <meta
          ...
          content="Help give away $375,000 to charity this November! Your first donation made via Givelist will be matched 1:1 up to $100, while funds last."
        />
      ...
      <Box as="main" sx={{ bg: 'landingChallenge', color: 'white', pt: 12 }}>
        ...
        <Flex as="section" sx={styles.section}>
          ...
          >
            ...
            <Text sx={styles.borderedText}>
              We are hoping to give away <strong>$375,000</strong> before the
