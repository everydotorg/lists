  ...
  nonprofits: [
    {
      ...
      location: '',
      about:
        'A nonprofit global security organization focused on transforming international security by driving systemic solutions to nuclear and biological threats imperiling humanity. NTI designs innovative threat-reduction projects that show governments the way and build momentum and support for action.',
    ...
    },
    {
      ...
      about:
        'The Johns Hopkins Center for Health Security works to protect people’s health from the consequences of epidemics and disasters. They explore how new policy approaches, scientific advances, and technological innovations can strengthen health security and save lives.',
