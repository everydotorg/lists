...
export const fff: LocalCampaignInfo = {
  ...
  bannerUrl: 'profile_pics/vsgc9buyuzny1sf34zob',
  socialShareText:
  ...
  nonprofits: [
    {
      ...
      about:
        'We explore wild places of Earth to document Fungi for conservation, habitat protection & livelihoods of those who depend on them.',
      img: 'profile_pics/gqurigs5mv0h2gyxsfmo'
    },
    {
      slug: 'globalwildlife',
      name: 'Re:wild',
      ...
      img: 'profile_pics/arxl1arg2xqhwsdwvkup'
    },
    {
      slug: 'iucnus',
      name: 'IUCNUS',
      ...
      img: 'profile_pics/wqxarwt81mfd4skyl9da'
    }
  ]
}
